...
export default async function EditProductPage({
    ...
    const product = await InventoryRepository.getProductById(companyId, productId);
    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500 max-w-2xl mx-auto">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h2 className="text-2xl font-bold tracking-tight text-[#323130]">Editar Producto</h2>
            ...
            <div className="rounded-md border border-[#e1dfdd] bg-white p-6 shadow-sm">
                <ProductForm companyId={companyId} initialData={product} />
            </div>
        </div>
    );
}
